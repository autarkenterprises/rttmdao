...
See **`config/pool.defaults.json`**: USDC-6-oriented defaults, **`proposalPassBps`** and **`joinApprovalBps`** at **`5000`** (strictly greater than 50%), and documented BPS semantics.
